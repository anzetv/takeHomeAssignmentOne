...
public:
	...
	//Postcondition: first = nullptr, last = nullptr, count = 0; 	282 | Chapter 5: Linked Lists 5
	...
	//Function to return the kth element of the list.
	//Precondition: The list must exist and must not be empty.
	//Postcondition: If the list is empty, the program
	//terminates; otherwise, the info on the kth
	//element of the list is returned.
	Type returnK_Element(const Type& kthItem) const;
	//Function to delete the kth element of the list.
	//Precondition: The list must exist and must not be empty.
	//Postcondition: If the list is empty, the program
	//outputs a relevant message; otherwise, the info on the 
	//kth element of the list is deleted.
	void deleteK_Element(const Type& kthItem) const;
	...
	//count is decremented by 1. Linked List as an ADT | 283
	...
	/*MARK: RAMID ENDS IN EVEN -> Assignment 4*/
